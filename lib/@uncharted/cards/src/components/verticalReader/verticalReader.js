...
export default class VerticalReader extends IBindable {
    ...
    _registerEvents() {
        ...
        $(window).resize(() => this._resizeReaderContentHeader());
    }
    ...
    _createNewReaderHolder() {
        ...
        $readerHolder[0].addEventListener('transitionend', event => {
            this._resizeReaderContentHeader();
    ...
    _resizeReaderContentHeader () {
        this._markedThumbnail && this._markedThumbnail.readerContent && this._markedThumbnail.readerContent.resizeHeader();
    }
    ...
    placeUnder(thumbnail, stayOpened) {
        ...
        requestAnimationFrame(() => thumbnail.readerContent.resizeHeader());
    }
