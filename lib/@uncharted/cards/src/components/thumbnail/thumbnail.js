...
export default class Thumbnail extends IBindable {
    ...
    reset(spec = {}) {
        ...
        this.headerImage.reset({ imageUrls: this.data.imageUrl, config: this._config });
    ...
    _renderReaderContent() {
        ...
        this.$element.find(this._config['thumbnail.disableFlipping'] ? '.card' : readerContainerSelector).html(this.readerContent.render());
        this.readerContent.resize();
    }
    ...
    flip(state) {
        ...
        if (this.$element) {
            ...
            this.readerContent && this._renderReaderContent();
        }
    }
    ...
    scaleHeaderImages() {
        this.headerImage.hasImages() && this._$cardImage && this.headerImage.scaleImages(this._$cardImage[0].offsetWidth, this._$cardImage[0].offsetHeight);
    }
}
